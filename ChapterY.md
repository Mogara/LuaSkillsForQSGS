...
==
#技能索引
[延祸](#延祸)、[严整](#严整)、[言笑](#言笑)、[燕语](#燕语)、[耀武](#耀武)、[业炎](#业炎)、[遗计](#遗计)、[疑城](#疑城)、[倚天](#倚天)、[义从](#义从)、[义从-贴纸](#义从-贴纸)、[义舍](#义舍)、[义释](#义释)、[异才](#异才)、[毅重](#毅重)、[姻礼](#姻礼)、[银铃](#银铃)、[英魂](#英魂)、[英姿](#英姿)、[影兵](#影兵)、[庸肆](#庸肆)、[勇决](#勇决)、[狱刎](#狱刎)、[御策](#御策)、[援护](#援护)
...
**描述**：**锁定技，**若你当前的体力值大于2，你计算的与其他角色的距离-1；若你当前的体力值小于或等于2，其他角色计算的与你的距离+1。  
**引用**：LuaYicong  
**状态**：1217验证通过
```lua
